...
The rendered documentation site lives at
[vekendianorg.github.io/nebula](https://vekendianorg.github.io/nebula/) —
this README is the same content in repo form. See
[CONTRIBUTING.md](CONTRIBUTING.md) for the code style and conventions;
[LICENSE](LICENSE) covers distribution.
...
reward arrays. See [PublicEvent API](docs/content/api/publicevent.md)

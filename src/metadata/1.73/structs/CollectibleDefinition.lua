...
M["id"] = { offset = 0x110, type = "String" }
M["type"] = { offset = 0x128, type = "Int32" }
M["amount"] = { offset = 0x12C, type = "Int32" }
M["multiplier"] = { offset = 0x130, type = "Float" }
M["sound"] = { offset = 0x138, type = "String" }
...
M["attachments"] = {
    ...
    type = "Array",
    elementStride = 0xF8,
    elements = Manifest.load("AttachmentDefinition")
}
M["rarity"] = { offset = 0x168, type = "Int32" }
M["weight"] = { offset = 0x16C, type = "Float" }
M["name"] = { offset = 0x170, type = "String" }
M["particles"] = { offset = 0x188, type = "String" }

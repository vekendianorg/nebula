--==================================================
-- GameStatus metadata — version 1.73
...
<<<<<<< HEAD:src/metadata/GameStatus.lua
...
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
--
...
-- locally the same way metadata/1.73/VehicleStatus.lua aliases its
...
-- 1.73.lua: each member keeps its own offset/type (POINTER,
...
local driverObj = { offset = 0x168, type = "Object" }
for k, v in pairs(Driver) do driverObj[k] = v end

local rewardManagerStatusObj = { offset = 0x1F8, type = "Object" }
for k, v in pairs(RewardManagerStatus) do rewardManagerStatusObj[k] = v end

local seasonStatusObj = { offset = 0x2E0, type = "Object" }
for k, v in pairs(SeasonStatus) do seasonStatusObj[k] = v end

local activeEventStatusObj = { offset = 0x320, type = "Object" }
for k, v in pairs(EventStatus) do activeEventStatusObj[k] = v end

local vipStatusObj = { offset = 0x3A8, type = "Object" }
for k, v in pairs(VipStatus) do vipStatusObj[k] = v end

local checkinRewardObj = { offset = 0x420, type = "Object" }
for k, v in pairs(CheckinReward) do checkinRewardObj[k] = v end

local scrapperStatusObj = { offset = 0x460, type = "Object" }
for k, v in pairs(ScrapperStatus) do scrapperStatusObj[k] = v end

local activeTeamEventStatusObj = { offset = 0x4A0, type = "Object" }
for k, v in pairs(EventStatus) do activeTeamEventStatusObj[k] = v end

local teamStatusObj = { offset = 0x4B0, type = "Object" }
for k, v in pairs(TeamStatus) do teamStatusObj[k] = v end

local kickedTeamStatusObj = { offset = 0x4C0, type = "Object" }
for k, v in pairs(KickedTeamStatus) do kickedTeamStatusObj[k] = v end

local teamSeasonStatusObj = { offset = 0x560, type = "Object" }
for k, v in pairs(TeamSeasonStatus) do teamSeasonStatusObj[k] = v end

local activeCommunityEventStatusObj = { offset = 0x660, type = "Object" }
for k, v in pairs(EventStatus) do activeCommunityEventStatusObj[k] = v end

local homeObj = { offset = 0x6A0, type = "Object" }
for k, v in pairs(Home) do homeObj[k] = v end

local communityEventObj = { offset = 0x710, type = "Object" }
for k, v in pairs(CommunityEvent) do communityEventObj[k] = v end

local currentGachaProgressObj = { offset = 0x7C8, type = "Object" }
for k, v in pairs(CurrentGachaProgress) do currentGachaProgressObj[k] = v end

local currentFriendEventObj = { offset = 0x7F0, type = "Object" }
for k, v in pairs(CurrentFriendEvent) do currentFriendEventObj[k] = v end

local winStreakEventObj = { id = "winStreakEvent", offset = 0x870, optional = true, tracked = true, type = "Object" }
for k, v in pairs(WinStreakEvent) do winStreakEventObj[k] = v end
...
=======
        ...
        -- its own snapshot (metadata/1.73/VehicleStatus.lua).
        elements = Manifest.load("VehicleStatus")
    },
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
...
=======
    ["rewardManagerStatus"] = rewardManagerStatusObj,  -- RewardManagerStatus
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["maxWCRank"] = {
        offset = 0x200,
        type = "Float"
...
=======
    ["seasonStatus"] = seasonStatusObj,  -- SeasonStatus
    ["purchasedIaps"] = {
        offset = 0x2E8,
        type = "Array",
...
=======
    ["activeEventStatus"] = activeEventStatusObj,  -- EventStatus
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["flags"] = {
        offset = 0x328,
        type = "BitMask",
...
=======
    ["vipStatus"] = vipStatusObj,  -- VipStatus
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["totalEventsJoined"] = {
        offset = 0x3B4,
        type = "Int32"
...
=======
    ["checkinReward"] = checkinRewardObj,  -- CheckinReward
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["seasonRank"] = {
        offset = 0x428,
        type = "Float"
...
=======
    ["scrapperStatus"] = scrapperStatusObj,  -- ScrapperStatus
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["totalScrapEarned"] = {
        offset = 0x480,
        type = "Int32"
...
=======
    ...
    ["activeTeamEventStatus"] = activeTeamEventStatusObj,  -- EventStatus
    ["teamStatus"] = teamStatusObj,  -- TeamStatus
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["specialTickets"] = {
        offset = 0x4AC,
        type = "Int32"
...
=======
    ["kickedTeamStatus"] = kickedTeamStatusObj,  -- KickedTeamStatus
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["teamEventOfferShown"] = {
        offset = 0x4C8,
        type = "String"
...
=======
    ["teamSeasonStatus"] = teamSeasonStatusObj,  -- TeamSeasonStatus
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
...
=======
    ...
    ["activeCommunityEventStatus"] = activeCommunityEventStatusObj,  -- EventStatus
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["currentPublicLevels"] = {
        offset = 0x668,
        type = "Array",
...
=======
    ...
    ["communityEvent"] = communityEventObj,  -- CommunityEvent
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["masteryBonusXp"] = {
        offset = 0x718,
        type = "SafeInt32"
...
=======
    ["currentGachaProgress"] = currentGachaProgressObj,  -- CurrentGachaProgress
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
...
=======
    ["currentFriendEvent"] = currentFriendEventObj,  -- CurrentFriendEvent
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["teamDonationTrack"] = {
        offset = 0x808,
        type = "Int32"
...
=======
    ["winStreakEvent"] = winStreakEventObj,  --WinStreakEvent
>>>>>>> main:src/metadata/1.73/structs/GameStatus.lua
    ["activeTriggers"] = {
        id = "activeTriggers",
        offset = 0x878,

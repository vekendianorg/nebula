-- metadata/1.73/LevelCollectibleStatus.lua
--==================================================
...
return {
    ...
    ["items"] = {
        offset = 0x20,
        type = "Array",
        elements = Manifest.load("LevelCollectibleItem")
    },
    ["collected"] = { offset = 0x38, type = "Array", elementType = "Int32", elementStride = 0x4 },
    ["totalCollectedValue"] = { offset = 0x48, type = "Int32" },
    ["totalValue"] = { offset = 0x4C, type = "Int32" },
}

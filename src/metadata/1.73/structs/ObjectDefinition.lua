--==================================================
-- metadata/1.73/ObjectDefinition.lua
--==================================================
...
return {
    ["sprite"] = { offset = 0x8, type = "String" },
    ["floaterSprite"] = { offset = 0x20, type = "String" },
    ["fullSprite"] = { offset = 0x50, type = "String" },
    ["spriteSheet"] = { offset = 0x68, type = "String" },
    ["animationFile"] = { offset = 0x80, type = "String" },
    ["colliderScale"] = { offset = 0xAC, type = "Float" },
    ["shape"] = { offset = 0xD0, type = "Int32" },
    ["density"] = { offset = 0xD4, type = "Float" },
    ["linearDamping"] = { offset = 0xD8, type = "Float" },
    ["angularDamping"] = { offset = 0xDC, type = "Float" },
    ["gravity"] = { offset = 0xE0, type = "Float" },
    ["restitution"] = { offset = 0xE4, type = "Float" },
    ["floaterIconScale"] = { offset = 0xE8, type = "Float" },
    ["verticalFlip"] = { offset = 0x108, type = "Bool" },
    ["sensor"] = { offset = 0x109, type = "Bool" },
}

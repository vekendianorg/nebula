...
return {
    ["claimedRewardCount"] = { offset = 0x18, type = "SafeInt32" },
    ["claimedRewards"] = { offset = 0x20, type = "Array", elementType = "Int32", elementStride = 0x4 },
    ["nextRewardIndex"] = { offset = 0x30, type = "Int32" },
}

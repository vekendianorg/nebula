...
return {
    ["levelStars"] = { offset = 0x18, type = "Array", elements = Manifest.load("StringIntMap") },
    ["levelDivisionMedals"] = { offset = 0x30, type = "Array", elements = Manifest.load("StringIntMap") },
    ...
    ["recentUsage"] = { offset = 0x70, type = "Array", elements = Manifest.load("RecentUsage") },
}
